    ...
    <div className="landing-container">
      ...
      <div className="landing-content">
        <div className="landing-main">
          ...
          <button className="start-button" onClick={handleCTAClick}>
            {session ? 'Dashboard' : 'Try Flow'}
          </button>
        </div>
      ...
      <div className="feature-cards">
        <div className="feature-card" style={{ '--card-index': 1 }}>
          ...
          <p>
            ...
            generate structured task breakdowns, saving hours of planning time.
          </p>
        </div>
        ...
        <div className="feature-card" style={{ '--card-index': 2 }}>
          ...
          <p>
            ...
            your engineering workflow smooth and efficient.
          </p>
        </div>
        ...
        <div className="feature-card" style={{ '--card-index': 3 }}>
          ...
          <p>
            ...
            entire team aligned and moving forward.
          </p>
        </div>
      </div>
      <Footer />

    ...
    <div className="flow-demo-container">
      <svg viewBox="0 0 800 400" className="flow-demo-svg">
        ...
        <rect
          ...
          rx="10"
        />
        <text className="terminal-prompt" x="70" y="85">
          $
        </text>
        ...
        <text className="assistant-text" x="70" y="120">
          <tspan className="assistant-line">
            Analyzing project requirements...
          </tspan>
          <tspan x="70" y="145" className="assistant-line">
            Generating task breakdown...
          </tspan>
          <tspan x="70" y="170" className="assistant-line">
            Creating Kanban structure...
          </tspan>
        </text>

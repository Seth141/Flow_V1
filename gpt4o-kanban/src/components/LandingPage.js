    ...
    <div className="landing-container">
      ...
      >
        <nav className="menu-content">
          <a href="#" onClick={(e) => { 
            e.preventDefault(); // Preventing default navigation
            toggleMenu(); 
          }}>
            Login
          </a>
      ...
      <div className="feature-cards">
        <div className="feature-card" style={{"--card-index": 1}}>
          ...
          <p>Let Flow analyze your project requirements and automatically generate structured task breakdowns, saving countless hours of planning time.</p>
        </div>
        ...
        <div className="feature-card" style={{"--card-index": 2}}>
          ...
          <p>Intelligent task categorization and priority management helps keep your engineering workflow smooth and on track.</p>
        </div>
        ...
        <div className="feature-card" style={{"--card-index": 3}}>
          ...
          <p>Visual progress indicators and automated status updates keep your entire team aligned and moving forward week after week.</p>
        </div>
      </div>
      <Footer />
    </div>

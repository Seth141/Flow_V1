...
function InteractiveDemo() {
  ...
  const steps = [
    {
      ...
      description:
        'Start by telling Flow about your project goals, team size, ideal timeline, and requirements.',
      icon: (
    ...
    },
    {
      ...
      description:
        "Flow's AI breaks down your project into organized, actionable tasks.",
      icon: (
        <svg viewBox="0 0 24 24" className="step-icon">
    ...
    },
    {
      ...
      description:
        'Tasks are automatically categorized and prioritized in your Kanban board.',
      icon: (
        <svg viewBox="0 0 24 24" className="step-icon">
    ...
    },
    {
      ...
      description:
        'Flow automatically monitors progress, adjusts priorities, and keeps your team pushing forward.',
      icon: (
        <svg viewBox="0 0 24 24" className="step-icon">
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (event, element) => {
      ...
      const highlightEffect = element.querySelector(
        '.detail-highlight-effect, .button-hover-effect'
      );
      if (highlightEffect) {
    ...
    <div className="interactive-demo-container" ref={demoRef}>
      ...
      <div className="demo-content">
        <div className="step-details">
          <div className="step-icon-container">{steps[activeStep].icon}</div>
        ...
        <div className="step-visualization">
          <div
            className={`animation-container ${isVisible ? steps[activeStep].animation : ''}`}
          >
            {activeStep === 0 && (
              <div className="visualization-content project-description-visualization">
                <div className="simple-chat-container">
                  <div className="chat-messages">
                    <div
                      className="assistant-message simple-fade-in"
                    ...
                    >
                      ...
                      <div className="message-content">
                        <p>
                          Hi there! I'm your Flow assistant. Tell me about your
                          project and I'll help organize it.
                        </p>
                      </div>
                    </div>

                    <div
                      className="user-message simple-fade-in"
                      style={{ '--fade-delay': '0.6s' }}
                    >
                      <div className="message-content">
                        <p>
                          We need to build an e-commerce platform with product
                          listings, shopping cart, and secure checkout.
                        </p>
                      </div>
                    ...
                    >
                      ...
                      <div className="message-content">
                        <p>
                          Thanks for the information. Flow is generating your
            ...
            {activeStep === 1 && (
              <div className="visualization-content ai-visualization">
                <div className="task-generation">
                  {[
                    {
                      text: 'Set up product database schema',
                      color: 'rgb(109, 85, 206)',
                      delay: 0,
                      instant: true,
                    },
                    {
                      text: 'Create product listing component',
                      color: 'rgb(147, 112, 219)',
                      delay: 200,
                    },
                    {
                      text: 'Implement shopping cart functionality',
                      color: 'rgb(126, 87, 194)',
                      delay: 400,
                    },
                    {
                      text: 'Set up payment gateway integration',
                      color: 'rgb(94, 53, 177)',
                      delay: 600,
                    },
                  ].map((task, index) => (
